...
$miuser = mysqli_query($conexion,"SELECT * FROM usuarios WHERE id_use = '$id'");
$use = mysqli_fetch_array($miuser,MYSQL_ASSOC);
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          if(isset($_POST['actualizar']))
          {
            ...
            $comprobar = mysqli_num_rows(mysql_query($conexion,"SELECT * FROM usuarios WHERE usuario = '$usuario' AND id_use != '$id'"));
            if($comprobar == 0){
            ...
            $sql = mysqli_query($conexion,"UPDATE usuarios SET nombre = '$nombre', usuario = '$usuario', email = '$email', sexo = '$sexo', nacimiento = '$nac', avatar = '$nombrea' WHERE id_use = '$id'");
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="control-sidebar-home-tab">
        ...
        <ul class="control-sidebar-menu">
          ...
          <li>
            <a href="javascript:void(0)">
              <i class="menu-icon glyphicon  glyphicon-user bg-yellow"></i>
