	...
	<!-- START PUBLICACIONES -->
          ...
          <div class="box box-widget">
            ...
            <ul class="list-inline">
              ...
              <?php
              $query = mysqli_query($conexion,"SELECT * FROM likes WHERE post = '".$lista['id_pub']."' AND usuario = ". $_SESSION['id'] ."");


echo mysqli_num_rows($query);
              if (mysqli_num_rows($query) == 0) { ?>

                <li><div class="btn btn-default btn-xs like" id="<?php echo $lista['id_pub']; ?>"><i class="fa fa-thumbs-o-up"></i> Me gusta </div><span id="likes_<?php echo $lista['id_pub']; ?>"> (<?php echo $lista['likes'] . " likes"; ?>)</span></li>
            ...
            <?php /*?>    <center><span
                onclick="location.href='publicacion.php?id=<?php echo $lista['id_pub'];?>';"
                  ...
                  style="cursor:pointer; color: #3C8DBC;"><a href="#openmodal" >Ver todos los comentarios</a></span></center>
...
<input type="text" class="name-<?php echo $aaa ?>"         value=" <?php echo $use['usuario']; ?> " />
<input type="text" class="date-<?php echo $aaa ?>"          value="<?php echo $lista['fecha']; ?> " />
<input type="text" class="icon-<?php echo $aaa ?>"    value="avatars/<?php echo $use['avatar']; ?>" />  
<input type="text" class="publication-<?php echo $aaa ?>" value="<?php echo $lista['contenido'];?>" />
<input type="text" class="prue-<?php echo $aaa ?>"         value=" <?php echo $use['usuario']; ?> " />

                  </form>
                  
                  <div class="btn btn-primary btn-block btn-flat  coment "   id="<?php echo $lista['id_pub'];  ?>" ><i class="fa fa-thumbs-o-up"></i> ver todos los comentarios </div>
	...
	//Validmos el incrementador para que no genere error
	//de consulta.
    if($IncrimentNum<=0){
	}else
	 {
