...
if(isset($_GET['leido'])) {
  ...
  $tchats = mysqli_query($conexion,"SELECT * FROM chats WHERE de = '$usuariod' OR para = '$usuariod'");
  $tc = mysqli_fetch_array($tchats,MYSQL_ASSOC);
  if($tc['de'] != $_SESSION['id']) {
  $update = mysqli_query($conexion,"UPDATE chats SET leido = '1' WHERE de = '$usuariod' OR para = '$usuariod'");
  }
}
?>
<!DOCTYPE html>
...
<?php echo Side (); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <!-- DIRECT CHAT PRIMARY -->
            <div class="else box-header with-border">
           
            <ul class="lista">
            <li > <div> <h3 class="box-title">NOMBRE USUARIO</h3></div></li>
            <li ><div >all screen</div></li>
            </ul>
            ...
            <div class="box-body">
              ...
              <div class="direct-chat-messages" style="overflow: scroll; height: 400px;">
                ...
                $sess = $_SESSION['id'];
                $chats = mysqli_query($conexion,"SELECT * FROM chats WHERE de = '$user' AND para = '$sess' OR de = '$sess' AND para = '$user' order by id_cha desc");
                while($ch = mysqli_fetch_array($chats)) { 
                  ...
                  $us = mysqli_fetch_array($usere,MYSQL_ASSOC);
                ?>
            ...
            <div class="box-footer">
              ...
              if(isset($_POST['enviar'])) {
                ...
                if(mysqli_num_rows($comprobar) == 0) {
                  ...
                  $si = mysqli_fetch_array($siguiente,MYSQL_ASSOC);
                  $insert2 = mysqli_query($conexion,"INSERT INTO chats (id_cch,de,para,mensaje,fecha,leido) VALUES ('".$si['id_cch']."','$de','$para','$mensaje',now(),'0')");
                  if($insert) {echo '<script>window.location="chat.php?usuario='.$para.'"</script>';}
                }
                else
                {
                  $insert3 = mysqli_query($conexion,"INSERT INTO chats (id_cch,de,para,mensaje,fecha,leido) VALUES ('".$com['id_cch']."','$de','$para','$mensaje',now(),'0')");
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      ...
      <li><a href="#control-sidebar-settings-tab" data-toggle="tab"><i class="glyphicon glyphicon-menu-down"></i></a></li>
    </ul>
    <!-- Tab panes -->
