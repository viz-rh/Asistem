          ...
          <div class="box box-widget">
            ...
            <ul class="list-inline">
              ...
              if (mysqli_num_rows($query) == 0) { ?>
                ...
                <li><div class="btn btn-default btn-xs like"  id="<?php echo $lista['id_pub']; ?>"><i class="glyphicon glyphicon-thumbs-up"></i> Me gusta </div><span id="likes_<?php echo $lista['id_pub']; ?>"> (<?php echo $lista['likes']; ?>)</span></li>

              <?php } else { ?>
                
                <li><div class="btn btn-default btn-xs like" id="<?php echo $lista['id_pub']; ?>"><i class="glyphicon glyphicon-thumbs-down"></i> No me gusta </div><span id="likes_<?php echo $lista['id_pub']; ?>"> (<?php echo $lista['likes']; ?>)</span></li>
            ...
            while($com=mysqli_fetch_array($comentarios,MYSQL_ASSOC)){
              ...
              <?php if ($numcomen > 2) { ?> 
              <br>
                <center><span onclick="location.href='publicacion.php?id=<?php echo $lista['id_pub'];?>#openmodal';" style="cursor:pointer; color: #3C8DBC;">Ver todos los comentarios</span></center>
              <?php } ?>
              ...
              <br>
                ...
                <input type="hidden" name="id_public" value="<?php $lista['id_pub'];
				?>" />
              </form>
