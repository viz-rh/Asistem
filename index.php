                ...
                <div class="box-footer">
                  <form action="" method="post" enctype="multipart/form-data">
                    <div class="input-group">
                      <textarea name="publicacion" onkeypress="return validarn(event)" placeholder="¿Qué estás pensando?" class="form-control" cols="200" rows="3" x></textarea>
                      <br><br><br><br>
...
//$name= $code.$rfoto;
                    ...
                    $llamar = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM albumes WHERE usuario ='".$_SESSION['id']."' AND nombre = 'Publicaciones'"));

                    if($llamar >= 1) {} else {

                    $crearalbum = mysqli_query($conexion,"INSERT INTO albumes (usuario,fecha,nombre) values ('".$_SESSION['id']."',now(),'Publicaciones')");

                   }

                   $idalbum = mysqli_query($conexion,"SELECT * FROM albumes WHERE usuario ='".$_SESSION['id']."' AND nombre = 'Publicaciones'");
                   $alb = mysqli_fetch_array($idalbum);

                    $subirimg = mysqli_query($conexion,"INSERT INTO fotos (usuario,fecha,ruta,album,publicacion) values ('".$_SESSION['id']."',now(),'$nombre','".$alb['id_alb']."','$next_increment')");

                    $llamadoimg = mysqli_query($conexion,"SELECT id_fot FROM fotos WHERE usuario = '".$_SESSION['id']."' ORDER BY id_fot desc");
                    $llaim = mysqli_fetch_array($llamadoimg,MYSQL_ASSOC);
                    ...
                    $subir = mysqli_query($conexion,"INSERT INTO publicaciones (usuario,fecha,contenido,imagen,album,comentarios) values ('".$_SESSION['id']."',now(),'$publicacion','".$llaim['id_fot']."','".$alb['id_alb']."','1')");
        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <?php $amistade = mysqli_query($conexion,"SELECT * FROM amigos WHERE para = '".$_SESSION['id']."' AND estado = '0' order by id_ami desc LIMIT 4");
              while($am = mysqli_fetch_array($amistade,MYSQL_ASSOC)) {

                $use = mysqli_query($conexion,"SELECT * FROM usuarios WHERE id_use = '".$am['de']."'");
                $us = mysqli_fetch_array($use,MYSQL_ASSOC);
                ?>
                <li class="item">
        ...
        <div class="col-md-4">
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  ...
                  <?php $registrados = mysqli_query($conexion,"SELECT avatar,usuario,fecha_reg FROM usuarios order by id_use desc limit 8");
                  while($reg=mysqli_fetch_array($registrados,MYSQL_ASSOC))
                  {
                  ?>
                    <li>
