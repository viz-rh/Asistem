...
<head>
  ...
  <title>Bienvenido a Asystem</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>a</b>system</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Bienvenido a Asystem</p>
...

        {
...

          {
			...
			$_SESSION['avatar'] = $row['avatar'];
  			...
  			setcookie("usuario_usu",$usuario,time()+16070400);
			setcookie("usuario_id",$row['id_use'],time()+16070400);
			setcookie("usuario_nombre",$row['nombre'],time()+16070400);
			setcookie("usuario_avatar",$row['avatar'],time()+16070400);
